...
2. Abra la [aplicación de puerta de enlace](/data-integration/gateway/service-gateway-app) y seleccione **Exportar registros** de la pestaña **Diagnóstico**.
