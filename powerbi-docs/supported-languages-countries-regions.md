...
> [!NOTE]
> El modelo de Power BI usa actualmente una configuración regional que no distingue mayúsculas de minúsculas (o no distingue kana), por lo que "ABC" y "abc" se tratarán como equivalentes. Si "ABC" se carga primero en la base de datos, otras cadenas que difieren solo en las mayúsculas, como "Abc", no se cargarán como un valor independiente.
> 
>
