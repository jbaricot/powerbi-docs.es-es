...
Para más información, consulte [Configure Windows Authentication on the Report Server](/sql/reporting-services/security/configure-windows-authentication-on-the-report-server) (Configuración de la autenticación de Windows en el servidor de informes).
