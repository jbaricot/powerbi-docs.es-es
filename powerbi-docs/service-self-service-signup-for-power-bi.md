...
* Power BI requiere que use una dirección de correo electrónico profesional o educativa para registrarse. No puede registrarse con direcciones de correo electrónico de proveedores de telecomunicaciones o de servicios de correo electrónico de consumidor. Esto incluye outlook.com, hotmail.com o gmail.com, entre otras. Si no tiene una cuenta profesional o educativa, [infórmese sobre las formas alternativas de registrarse.](service-admin-signing-up-for-power-bi-with-a-new-office-365-trial.md)
...
1. Llegados a este punto, es posible que tenga que esperar si Microsoft [está configurando un nuevo inquilino](service-admin-signing-up-for-power-bi-with-a-new-office-365-trial.md). En caso contrario, el servicio Power BI se abrirá en el explorador.
