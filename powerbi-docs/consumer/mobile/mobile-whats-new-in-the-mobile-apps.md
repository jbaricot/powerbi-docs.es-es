...
### <a name="support-for-power-bi-in-split-screens-android-tablets-only"></a>Compatibilidad con Power BI en pantallas divididas (solo tabletas Android)

Si su tableta Android tiene compatibilidad con varias ventanas, puede ver los datos e interactuar con ellos en paralelo con otra aplicación mediante el modo de pantalla dividida. [Obtenga más información al respecto](mobile-apps-split-screen.md).

![Captura de pantalla de la aplicación móvil que se usa en modo de pantalla dividida](media/mobile-whats-new-in-the-mobile-apps/power-bi-mobile-split-screen.png)

## <a name="january-2021"></a>Enero de 2021
### <a name="workspace-support-with-a-power-bi-free-license"></a>Compatibilidad de las áreas de trabajo con una licencia gratuita de Power BI
Los usuarios con una licencia gratuita de Power BI pueden ver las áreas de trabajo a las que se les haya agregado como espectadores directamente desde la lista de áreas de trabajo, así como acceder a ellas. Este cambio se aplica al contenido hospedado en una capacidad de Power BI Premium.

## <a name="december-2020"></a>Diciembre de 2020
### <a name="weve-added-anomaly-detection-to-the-mobile-apps"></a>La detección de anomalías se agregó a las aplicaciones móviles
Si el creador del informe ha configurado la detección de anomalías para un objeto visual de informe, puede ver si hay picos o caídas inesperados en los datos provocados por valores atípicos de datos (es decir, anomalías). [Obtenga más información al respecto](mobile-reports-in-the-mobile-apps.md#investigate-anomalies-in-time-series-data).

![Captura de pantalla de la detección de anomalías.](media/mobile-whats-new-in-the-mobile-apps/mobile-anomaly-detection.png)

### <a name="easily-find-your-orgs-endorsed-content"></a>Búsqueda sencilla del contenido aprobado de la organización
El contenido [promovido o certificado](../../collaborate-share/service-endorsement-overview.md) en el servicio Power BI ahora aparece etiquetado en la aplicación con un distintivo. Los creadores de informes promueven su contenido para mostrar que está listo para su uso (promovido) o certifican su contenido para mostrar que lo aprobó su organización (certificado).

![Captura de pantalla del informe certificado en la información de informe en dispositivos móviles.](media/mobile-whats-new-in-the-mobile-apps/mobile-apps-certified-badge.png)
...
Ahora, las páginas de informe configuradas con la [actualización automática de página](../../create-reports/desktop-automatic-page-refresh.md) también se actualizarán automáticamente en la aplicación Power BI para dispositivos Windows. Y no solo en la vista de informes normal. Con la actualización automática de página, las [presentaciones y diapositivas](mobile-windows-10-app-presentation-mode.md#slideshows) se actualizarán en tiempo real, lo que asegurará que siempre verá los últimos datos empresariales y conclusiones.

### <a name="support-for-notch-displays-ios"></a>Compatibilidad con pantallas con muesca (iOS)
Hemos agregado compatibilidad para el uso de pantallas con muesca en iPhone y iPad, lo que le proporcionará más espacio en pantalla para sus informes y paneles. 

## <a name="september-2020"></a>Septiembre de 2020
### <a name="power-bi-app-preview-for-hololens-2-is-out-in-the-stores"></a>La aplicación Power BI (versión preliminar) para HoloLens 2 ya está en las tiendas.

La aplicación Power BI para HoloLens 2 ofrece una experiencia completamente envolvente. Con el sistema de gestos manuales de HoloLens 2, puede sacar sus informes y paneles favoritos del conjunto de herramientas, cambiar su tamaño y colocarlos donde los necesite, e incluso navegar por las páginas del informe. Los informes y los paneles se actualizan mientras se usa la aplicación, por lo que si cambian los datos, los cambios se verán inmediatamente. Obtenga más información en nuestra [documentación](mobile-hololens2-app.md) y [blog](https://powerbi.microsoft.com/blog/power-bi-app-for-mixed-reality-now-available-for-hololens-2/).
...
### <a name="share-from-power-bi-using-your-favorite-apps-ios-and-android"></a>Uso compartido de Power BI mediante las aplicaciones favoritas (iOS y Android)
Ahora puede compartir vínculos a contenido de Power BI con los contactos. Use la nueva acción Compartir del encabezado para enviar el vínculo mediante cualquier aplicación de colaboración que tenga en el dispositivo, como Microsoft Teams, una aplicación de correo, etc. El vínculo captura la vista actual, por lo que incluso puede compartir vistas de informe filtradas.

![Captura de pantalla del icono Compartir de la aplicación móvil de Power BI.](media/mobile-whats-new-in-the-mobile-apps/power-bi-mobile-share.png)

### <a name="pinch-and-zoom-is-now-available-in-all-report-views---on-both-phones-and-tablets-ios-and-android"></a>Reducir y ampliar ahora está disponible en todas las vistas del informe, tanto en teléfonos como tabletas (iOS y Android)   
Se ha habilitado Reducir y ampliar en todas las vistas del informe, lo que facilita acercarse o alejarse en el contenido del informe, ya sea en un teléfono o una tableta.

### <a name="auto-play-a-slideshow-on-startup-windows"></a>Reproducción automática de una presentación al iniciar (Windows)
Puede elegir un informe para que se reproduzca automáticamente en una presentación cuando se inicia la aplicación de Power BI en Windows. Esto resulta útil para crear una experiencia similar a la de un quiosco multimedia en la que se ejecute un informe en pantallas públicas sin intervención manual. [Obtenga más información al respecto](mobile-windows-10-app-presentation-mode.md#auto-play-a-slideshow-on-startup).
...
### <a name="use-shortcuts-and-google-search-to-launch-your-content-android"></a>Uso de accesos directos y Google Search para iniciar el contenido (Android)
Hemos facilitado la búsqueda y el inicio de los datos mediante la integración de accesos directos y Google Search con la aplicación Power BI. Cree accesos directos para facilitar el acceso a sus informes y paneles favoritos directamente desde la pantalla de inicio del dispositivo. Y use Google Search para buscar y abrir rápidamente el contenido de Power BI. Obtenga más información sobre los [accesos directos a aplicaciones de Android](mobile-app-quick-access-shortcuts.md) y [Google Search](mobile-app-find-access-google-search.md).

### <a name="enhanced-security-using-device-protection-preview-android"></a>Seguridad mejorada con la protección de dispositivos, versión preliminar (Android)
Use las capacidades integradas de protección del dispositivo para proteger la aplicación Power BI y obtener la privacidad que necesita. Requerir la autenticación biométrica (Fingerprint ID) para acceder a la aplicación Power BI garantiza que los datos se mantengan privados y que solo usted los pueda ver. [Más información sobre el acceso seguro nativo](mobile-native-secure-access.md)

### <a name="scanning-is-now-available-on-ipad"></a>La digitalización ya está disponible en iPad
Ahora, directamente desde su iPad, puede digitalizar códigos de barras para filtrar los informes y usar códigos QR con el fin de abrir informes rápidamente.  

### <a name="updated-filtering-experience"></a>Experiencia de filtrado actualizada
Los filtros en la aplicación Power BI van a tener una función y un diseño nuevos. Esto incluye una visibilidad mejorada de los filtros aplicados que afectan a los objetos visuales del informe y la capacidad de bloquear e incluso ocultar filtros. Estos cambios también proporcionan una mejor compatibilidad con el filtrado en el servicio Power BI.
...
Nos hemos asociado con el equipo de Azure Active Directory para integrar aplicaciones móviles de Power BI con Application Proxy de Azure Active Directory (Azure AD). Con esta configuración, puede conectarse a Report Server hospedado dentro de los límites de la empresa desde la aplicación Power BI Mobile sin la necesidad de establecer una configuración local compleja. Obtenga más información sobre la [integración de Power BI Mobile y Azure Active Directory Application Proxy](https://powerbi.microsoft.com/blog/access-on-prem-report-server-from-your-power-bi-mobile-app-with-azure-active-directory-application-proxy/). Aprenda a [configurar Azure Active Directory (AAD) Application Proxy y Power BI](/azure/active-directory/manage-apps/application-proxy-integrate-with-power-bi).
...
Integración con la [nueva funcionalidad de acceso condicional basado en la protección de aplicaciones](/azure/active-directory/conditional-access/app-protection-based-conditional-access) de Azure AD para aumentar la seguridad al limitar el acceso a Power BI antes de aplicar la directiva de aplicación.

### <a name="device-protection-ios"></a>Protección de dispositivos (iOS)

Los usuarios pueden usar la protección de dispositivos integrada para proteger Power BI mediante la solicitud de la identificación Face ID, Touch ID o un código de acceso para acceder a Power BI. El usuario puede controlar este aspecto mediante la configuración de la aplicación y también los administradores mediante Intune y cualquier otra herramienta MDM. [Más información](./mobile-native-secure-access.md).
...
> [!NOTE]
> Los usuarios existentes deberán activar este comportamiento en la configuración de la aplicación. Para más información, consulte el artículo [Cómo configurar la interacción de una sola pulsación con el informe](./mobile-app-interaction-settings.md).
...
La aplicación Power BI para Mixed Reality ya está en Microsoft Store. Esta aplicación permite consultar paneles e informes mientras el usuario está inmerso en la realidad virtual, o colocarlos y consultarlos en ubicaciones específicas en el contexto de su entorno. Vea el vídeo nuevo [Introducing Power BI on Hololens](https://www.youtube.com/watch?v=J_X_nOFUBss) (Introducción a Power BI en Hololens) para obtener contexto o lea el artículo sobre la nueva [aplicación Power BI for Mixed Reality](./mobile-hololens2-app.md).
...
Nuestros esfuerzos más recientes por llevar los datos allá donde se encuentren los usuarios se han materializado con la creación de la aplicación Power BI for Mixed Reality. Esta aplicación permite consultar paneles e informes mientras el usuario está inmerso en la realidad virtual, o colocarlos y consultarlos en ubicaciones específicas en el contexto de su entorno. Si quiere saber más, vea [Aplicación Power BI for Mixed Reality (versión preliminar)](./mobile-hololens2-app.md).
...
Ahora puede pulsar los vínculos de los objetos visuales de Power BI para abrirlos en el explorador para dispositivos móviles.
...
**Agregar aplicaciones a favoritos** Ya sabe cómo agregar un panel a Favoritos. Recientemente, [Power BI agregó aplicaciones](../../collaborate-share/service-create-distribute-apps.md) y ya puede también agregar aplicaciones a Favoritos. 
...
#### <a name="ios-devices"></a>Dispositivos iOS
**Formulación de preguntas sobre los datos mediante Preguntas y respuestas, y envío de comentarios** Pruebe a formular preguntas sobre los datos mediante Preguntas y respuestas y, luego, envíenos una cara sonriente o triste para que sepamos qué tal lo hemos hecho.
...
**Clasificación de datos del panel** Vea las clasificaciones de datos que los propietarios del panel han asignado a sus escritorios. Obtenga más información sobre cómo [clasificar paneles](../../create-reports/service-data-classification.md).
...
Obtenga más información acerca de [Microsoft Intune en aplicaciones móviles de Power BI](../../admin/service-admin-mobile-intune.md).
...
#### <a name="all-phones"></a>Todos los teléfonos
En el servicio Power BI ahora puede [crear una vista de un panel específicamente para teléfonos](../../create-reports/service-create-dashboard-mobile-phone-view.md) en modo vertical. 
...
**Paneles de Bing** En el servicio Power BI, ahora se pueden crear [paneles con los resultados de búsquedas en Bing](../../connect-data/service-connect-to-services.md) y verlos en el dispositivo móvil.
...
* Entrada de blog [SQL 16 SSRS on Power BI app for iOS](https://powerbi.microsoft.com/blog/sql-16-ssrs-on-power-bi-app-for-ios/
) (SQL 16 SSRS en la aplicación Power BI para iOS)
...
* Lea la [entrada de blog sobre la aplicación Power BI para teléfonos con Windows 10](https://powerbi.microsoft.com/blog/announcing-the-power-bi-app-for-windows-10-mobile/).
...
Para más información, lea la [entrada de blog de diciembre sobre aplicaciones móviles de Power BI](https://powerbi.microsoft.com/blog/power-bi-mobile-apps-update-2d00-december-2015/).
...
* [Escanee un código QR](https://powerbi.microsoft.com/blog/bridge-the-gap-between-your-physical-world-and-your-bi-using-qr-codes/) y vaya directamente al icono pertinente en el teléfono Android.

### <a name="november-2015"></a>Noviembre de 2015
Lea la [entrada del blog sobre aplicaciones móviles de Power BI de noviembre de 2015](https://powerbi.microsoft.com/blog/power-bi-mobile-apps-update-2d00-november-2015/).
...
* Ahora las empresas pueden [configurar aplicaciones móviles de Power BI para iOS y Android con Microsoft Intune](../../admin/service-admin-mobile-intune.md) para administrar dispositivos y aplicaciones.

#### <a name="iphone-mobile-app"></a>Aplicación móvil de iPhone
* [Agregue un icono de imagen a un panel](mobile-iphone-app-get-started.md) directamente desde el iPhone.
* [Cree códigos QR en el servicio Power B](../../create-reports/service-create-qr-code-for-tile.md)I y, después, escanéelos desde el iPhone para abrir la aplicación Power BI en un icono concreto.

#### <a name="the-power-bi-app-for-windows-devices"></a>Aplicación de Power BI para dispositivos Windows
* [Cree un vínculo directamente desde un icono a una dirección URL concreta](../../create-reports/service-dashboard-edit-tile.md#hyperlink).

### <a name="october-2015"></a>Octubre de 2015
Lea la [entrada del blog sobre aplicaciones móviles de Power BI de mediados de octubre](https://powerbi.microsoft.com/blog/power-bi-mobile-mid-october-updates-are-here/).
