...
Para obtener acceso rápido y sencillo a los informes o paneles que se usan con frecuencia, puede crear un acceso directo de Siri para el acceso directo al contenido de Power BI que necesita. Con un acceso directo de Siri, solo tiene que pedirle a Siri que lo abra cada vez que necesite examinar los datos.

> [!NOTE]
> La integración de los accesos directos de Siri con la aplicación móvil de Power BI está disponible para iPhone y iPad con iOS 12 y versiones posteriores.
...
- Use la opción **Accesos directos sugeridos** de la configuración del dispositivo (**Configuración del dispositivo** > **Siri y Búsqueda**). Puede agregar un acceso directo al elemento de la sugerencia mediante el botón de signo más (+).
     ...
     ![Crear un acceso directo](./media/mobile-apps-ios-siri-search/power-bi-siri-create-shortcut.png)
...
## <a name="create-a-home-screen-shortcut-from-your-siri-shortcut"></a>Creación de un acceso directo a la pantalla principal desde el acceso directo de Siri 
Una vez que haya creado un acceso directo de Siri a contenido de Power BI, también puede agregarlo a la pantalla principal del dispositivo, para abrirlo directamente desde la pantalla principal con una sola pulsación. Siga las instrucciones https://support.apple.com/guide/shortcuts/apd735880972/ios.
