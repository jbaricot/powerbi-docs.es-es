...
Un trabajo que supera su número de solicitudes simultáneas no finaliza. Por ejemplo, si exporta tres páginas en una SKU A1, se ejecutará el primer trabajo y los dos últimos esperarán a los dos próximos ciclos de ejecución.
...
* El informe que está exportando debe residir en una capacidad.
* El conjunto de datos del informe que está exportando debe residir en una capacidad.
