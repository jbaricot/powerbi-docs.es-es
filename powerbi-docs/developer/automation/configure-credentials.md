---
title: Configuración de credenciales mediante programación para análisis integrados de Power BI para procurar una mejor información de BI insertada
description: Procedimiento para configurar credenciales mediante programación cuando Power BI se automatiza. Consiga mejores conclusiones insertadas de BI con los análisis insertados de Power BI.
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi
...
5. Compile los detalles de las credenciales con credenciales cifradas.
    ...
    Use la clase AssymetricKeyEncryptor con la clave pública recuperada en el **paso 3**.
