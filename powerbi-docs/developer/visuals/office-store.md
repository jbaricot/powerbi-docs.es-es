...
Una vez que haya creado un objeto visual de Power BI, puede publicarlo en AppSource para que otros usuarios lo detecten y lo usen. Para más información sobre cómo crear un objeto visual de Power BI, consulte [Desarrollo de un objeto visual Circle Card de Power BI](develop-circle-card.md).
