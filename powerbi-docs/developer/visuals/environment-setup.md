---
title: Configuración del entorno para el desarrollo de un objeto visual de Power BI
description: En este artículo se explica cómo configurar el entorno para poder desarrollar un objeto visual de Power BI.
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi
...
1. Abra VS Code.
    ...
    >[!TIP]
    >Para abrir VS Code desde PowerShell, ejecute el siguiente comando:
    >
    >```powershell
    >code .
    >```
