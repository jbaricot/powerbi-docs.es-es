...
| PowerBIEntityNotFound | Error al obtener el informe | 404 | <li> Identificador de informe incorrecto <li> Informe inexistente  |
...
|-------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|------------|-------------------------------------------------|
| TokenExpired | Expiró el token de acceso, vuelva a realizar el envío con uno nuevo. | 403 | Token expirado  |
| LoadReportFailed | Error al obtener el informe | 404 | <li> Identificador de informe incorrecto <li> Informe inexistente  |
