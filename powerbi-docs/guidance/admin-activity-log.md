...
- El usuario del script de PowerShell debe iniciar sesión con el [cmdlet Connect-PowerBIServiceAccount](/powershell/module/microsoftpowerbimgmt.profile/connect-powerbiserviceaccount) y escribir las credenciales de administrador de inquilinos de Power BI cuando se le solicite. Se requieren privilegios de administrador de inquilinos para usar la API de registro de actividad.

> [!IMPORTANT]
> Los usuarios sin privilegios de administrador de inquilinos no podrán ejecutar fragmentos de código en el script de muestra.
