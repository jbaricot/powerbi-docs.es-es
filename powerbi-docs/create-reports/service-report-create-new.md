...
1. Seleccione **Más opciones (...)** junto al conjunto de datos y luego **Crear informe** .
   ...
   :::image type="content" source="media/service-report-create-new/power-bi-dataset-create-report.png" alt-text="Captura de pantalla de la selección de Mi área de trabajo.":::
...
> 
> :::image type="content" source="../media/power-bi-hide-navigation-pane.png" alt-text="Captura de pantalla de la selección de Mi área de trabajo.":::
