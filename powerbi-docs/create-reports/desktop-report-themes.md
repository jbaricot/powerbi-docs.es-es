...
Puede ver las seis clases de color a las que puede aplicar formato en la tabla siguiente.  Los nombres relativos a **Clase de color** corresponden a los nombres de la subsección "Avanzado" de la sección "Nombre y colores" del [cuadro de diálogo **Personalización del tema**](#create-and-customize-a-theme-in-power-bi-desktop).
