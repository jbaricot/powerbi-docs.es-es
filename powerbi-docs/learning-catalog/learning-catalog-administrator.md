...
description: Busque todas las opciones de aprendizaje de Power BI para administradores, de la más básica a la más avanzada.
author: margoc
ms.prod: powerbi
ms.topic: article
ms.date: 03/25/2020
...
| [Seminario web 18/10/18: Preguntas y respuestas sobre la administración de capacidades Premium](https://community.powerbi.com/t5/Webinars-and-Video-Gallery/10-18-18-Webinar-Q-amp-A-on-Managing-Premium-Capacities/td-p/535555)  | Únase a Charles Sterling y Josh Caplan a medida que responden las preguntas de los clientes de Power BI sobre la administración de capacidades Premium.  | Seminario web | 59 min 20 s     |
