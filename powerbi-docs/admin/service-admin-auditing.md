...
| Creación del área de trabajo de la aplicación de plantilla de Power BI | CreateTemplateApp   |
| Creación del vale de instalación de la aplicación de plantilla de Power BI | CreateTemplateAppInstallTicket |
| Creación del paquete de la aplicación de plantilla de Power BI | CreateTemplateAppPackage |
...
| Área de trabajo de la aplicación de plantilla de Power BI eliminada | DeleteTemplateApp |
| Paquete de la aplicación de plantilla de Power BI eliminado | DeleteTemplateAppPackage |
...
| Paquete de la aplicación de plantilla de Power BI extraído en el área de trabajo | ExtractTemplateAppPackage |
...
| Aplicación de plantilla de Power BI instalada | InstallTemplateApp |
...
| Paquete de la aplicación de plantilla de Power BI promocionado | PromoteTemplateAppPackage |
...
| Parámetros actualizados de la aplicación de plantilla de Power BI instalada | UpdateInstalledTemplateAppParameters |
...
| Configuración de la aplicación de plantilla de Power BI actualizada | UpdateTemplateAppSettings |
| Permisos de acceso de prueba de la aplicación de plantilla de Power BI actualizados | UpdateTemplateAppTestPackagePermissions |
