...
* Solo se admiten los [objetos visuales certificados de Power BI](developer/visuals/power-bi-custom-visuals.md) y predeterminados para las suscripciones de correo electrónico.  
