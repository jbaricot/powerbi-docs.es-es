...
## <a name="two-ways-to-get-started"></a>Dos maneras sencillas de empezar
Hay dos formas diferentes de explorar los conjuntos de datos de Power BI en Excel: si va a empezar desde Power BI, siga los pasos descritos en este documento.  Ahora también existe la posibilidad de que los usuarios con ciertas SKU de Office tengan acceso a sus conjuntos de datos directamente desde la experiencia Obtener datos dentro de un libro de Excel.  Pueden examinar los conjuntos de datos a los que tienen acceso, ver si los conjuntos de datos están certificados o promocionados, y si se han aplicado etiquetas de protección de datos.  Para saber más sobre esta experiencia, vea [Crear una tabla dinámica a partir de conjuntos de valores de Power BI](https://support.office.com/article/31444a04-9c38-4dd7-9a45-22848c666884) en la documentación de Excel.
...
* Los usuarios invitados no pueden usar **Analizar en Excel** para los conjuntos de datos enviados desde otro inquilino. 
...
## <a name="get-started-with-analyze-in-excel-in-power-bi"></a>Introducción a Analizar en Excel de Power BI
...
Tendrá la oportunidad de iniciar sesión de nuevo, momento en el cual puede hacerlo con la cuenta de Power BI que tiene acceso a dicho conjunto de datos. También puede seleccionar su nombre en la cinta de opciones superior de Excel, que identifica la cuenta con la que ha iniciado actualmente sesión. Cierre la sesión y vuelva a iniciarla con una cuenta distinta.
